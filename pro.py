...
icono = pygame.image.load("neutron.png")
pygame.display.set_icon(icono)

portada=tablero = pygame.image.load("portada.png").convert()
tablero = pygame.image.load("tablero.png").convert()


boton1a=pygame.image.load('boton_0.png').convert_alpha()
boton1b=pygame.image.load('boton_1.png').convert_alpha()
...
UI = pygame.image.load('margenes.png').convert_alpha()
...
class Boton():
  ...
  def __init__(self,tipo,imagen,coordenadas):
    ...
    self.ima = pygame.image.load("boton_1.png").convert_alpha()
    if self.tipo=='jugar':
      ...
      if mouse1==True:
        ...
        self.mouse=True
      if mouse1==False:
        self.ima = pygame.image.load("boton_0.png").convert_alpha()
        self.mouse=False

    if self.tipo=='nivel':
      mouse2=mouseover(imagen,coordenadas)
      if mouse2==True:
        self.ima = pygame.image.load("niveles_1.png").convert_alpha()
        self.mouse=True
      if mouse2==False:
        self.ima = pygame.image.load("niveles_0.png").convert_alpha()
        self.mouse=False
        
    if self.tipo=='pausa':
      mouse3=mouseover(imagen,coordenadas)
      if mouse3==True:
        self.ima = pygame.image.load("pausa_1.png").convert_alpha()
        self.mouse=True
      if mouse3==False:
        self.ima = pygame.image.load("pausa_0.png").convert_alpha()
        self.mouse=False
        
    if self.tipo=='info':
      mouse4=mouseover(imagen,coordenadas)
      if mouse4==True:
        self.ima = pygame.image.load("info_1.png").convert_alpha()
        self.mouse=True
      if mouse4==False:
        self.ima = pygame.image.load("info_0.png").convert_alpha()
        self.mouse=False
        
    if self.tipo=='n_1':
      mouse5=mouseover(imagen,coordenadas)
      if mouse5==True:
        self.ima = pygame.image.load("1_1.png").convert_alpha()
        self.mouse=True
      if mouse5==False:
        self.ima = pygame.image.load("1_0.png").convert_alpha()
        self.mouse=False
        
    if self.tipo=='n_2':
      mouse6=mouseover(imagen,coordenadas)
      if mouse6==True:
        self.ima = pygame.image.load("2_1.png").convert_alpha()
        self.mouse=True
      if mouse6==False:
        self.ima = pygame.image.load("2_0.png").convert_alpha()
        self.mouse=False
        
    if self.tipo=='n_3':
      mouse7=mouseover(imagen,coordenadas)
      if mouse7==True:
        self.ima = pygame.image.load("3_1.png").convert_alpha()
        self.mouse=True
      if mouse7==False:
        self.ima = pygame.image.load("3_0.png").convert_alpha()
        self.mouse=False
